...
/**
 * EstatusUsuarioUsuarioSearch represents the model behind the search form of `app\models\PerfilUsuarioUsuario`.
 */
class EstatusUsuarioUsuarioSearch extends PerfilUsuarioUsuario
{
    /**
     * {@inheritdoc}
     */
